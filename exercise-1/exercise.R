...
get_request2 <- GET(paste0(url, resource), query = query_params)

# Extract the response body and convert it from JSON.
extract_text2 <- content(response, "text")
results <- fromJSON(extract_text2)
